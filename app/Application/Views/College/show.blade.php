...
@section('content')
    <div class="college-information mb-2">
        ...
        <h4><b>College:</b> {{ $college->collegeName  }}</h4>
        <h4><b>Created At:</b> {{ $college->createdAt?->format('F j, Y g:i a') }}</h4>
        <h4><b>Update At:</b> {{ $college->updatedAt?->format('F j, Y g:i a') }}</h4>
    </div>
