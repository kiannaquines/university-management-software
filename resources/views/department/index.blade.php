            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-3">
                        <a href="{{ route('department.create') }}" class="btn text-white bg-blue-600 rounded p-2 mb-2">Add
                            New Department</a>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        ...
                        a') }}</td>
                                    ...
                                    <td class="border-b border-gray-300 px-4 py-2 flex space-x-2">
                                        <a href="{{ route('department.show', $department->id) }}" class="text-blue-600
                            hover:underline">View</a>
                                        <a href="{{ route('department.edit', $department->id) }}" class="text-yellow-600
                            hover:underline">Edit</a>
                                        <a href="{{ route('department.confirm', $department->id)  }}" class="text-red-600
